...
export default {
  ...
  nav: {
    ...
    myProfile: 'Perfil',
    profileNoticeUnread: 'Tenés un aviso de la federación',
    notices: 'Avisos',
    noticesEmptyTitle: 'Sin avisos',
    noticesEmpty: 'No tenés comunicados pendientes de la federación.',
    myAthleteAccount: 'Mi cuenta atleta',
    myMembership: 'Afiliación',
    backToAdmin: 'Volver al panel',
    roleAdmin: 'Administración',
    roleAthlete: 'Atleta oficial',
    roleStaffAccess: 'Acceso operativo',
  ...
  account: {
    ...
    navScrollHint: 'Deslizá horizontalmente para ver más secciones.',
    nav: {
      qr: 'Credencial',
      benefits: 'Beneficios',
      offer: 'Tu código',
    ...
    offer: {
      ...
      profileIncomplete: 'Antes de inscribirte, completá los datos que faltan en tu perfil.',
    ...
    profileNotice: {
      ...
      lead: 'Para inscribirte a un evento oficial faltan: {{fields}}.',
    ...
    membership: {
      ...
      transferWiseRoutingNumber: 'Número de ruta',
      transferWiseAccountNumber: 'Número de cuenta',
      transferWiseAccountType: 'Tipo de cuenta',
      transferWiseAddress: 'Dirección Wise',
      ...
      transferWiseVerifyWarning:
        'Verificá titular, número de ruta, número de cuenta y Swift/BIC antes de transferir.',
      transferCopy: 'Copiar',
    ...
    personalData: {
      ...
      lead: 'Tocá un bloque para editar. Los campos con * hacen falta para inscribirte.',
      ...
      competitionGroup: 'Competencia',
      competitionSummaryFallback: 'División, categoría y peso',
      sportsGroup: 'Equipo',
      sportsSummary: 'Gimnasio y sexo competitivo',
      ...
      errorDivision: 'Seleccioná tu división.',
      errorCategory: 'Seleccioná tu categoría.',
      errorEstimatedWeight: 'Ingresá un peso estimado entre 10 y 250 kg.',
      ...
      pending: 'Pendiente',
      checklistLead: 'Para inscribirte falta completar:',
    },
    security: {
      eyebrow: 'Cuenta',
      title: 'Seguridad',
  ...
  pages: {
    ...
    events: {
      ...
      map: {
        ...
        embedTitle: 'Mapa de la sede en OpenStreetMap',
        ...
        retryInteractive: 'Probar mapa interactivo',
    ...
    pitbull: {
      ...
      viewMyRegistration: 'Ver mi inscripción',
      ...
      ticketsSoonEyebrow: 'Espectadores',
      ticketsSoonTitle: 'El público también entra',
      ticketsSoonLead:
        'Dos jornadas en Banfield, de cerca, con el mismo estándar de plataforma. La venta se habilita acá.',
      ticketsSoonMark: 'Próximamente',
      ...
      recentRegistrantsLiveMeta: '{{count}} hoy · En vivo',
      recentRegistrantsToday: '{{count}} hoy',
      recentRegistrantsTodayBadge: '{{count}} inscritos hoy',
      recentRegistrantsTodayMark: 'Hoy',
      ...
      inscriptionCounterAriaNoTotal:
        'Progreso de inscripción: {{registered}} anotados, quedan {{remaining}} lugares',
      ...
      inscriptionCounterHiddenMark: 'Campo limitado',
      inscriptionCounterHidden: 'La inscripción está abierta. El avance no se muestra en público.',
      inscriptionCounterHiddenAria: 'Inscripción abierta. El cupo de atletas no se publica.',
      inscriptionCounterClosedMark: 'Inscripciones cerradas',
      inscriptionCounterClosed: 'Por el momento no se aceptan más inscripciones.',
      inscriptionCounterClosedAria:
        'Inscripciones cerradas. Por el momento no se aceptan más inscripciones.',
      inscriptionCounterFullMark: 'Cupo completo',
      inscriptionCounterFull: 'No quedan lugares para este meet.',
      inscriptionCounterFullAria: 'Cupo completo. No quedan lugares para este meet.',
      inscriptionCounterFinishedMark: 'Evento finalizado',
      inscriptionCounterFinished: 'La inscripción de este meet ya cerró.',
      inscriptionCounterFinishedAria: 'Evento finalizado. La inscripción de este meet ya cerró.',
      inscriptionCounterRegistered: 'anotados',
      inscriptionCounterRemaining: 'Quedan {{count}} lugares',
      inscriptionCounterRemainingOne: 'Queda 1 lugar',
    ...
    register: {
      ...
      gymConfirmation: {
        title: 'Confirmá el nombre de tu equipo',
        description: 'No encontramos un equipo con este nombre. ¿Está escrito correctamente?',
        warning: 'Si lo confirmás, quedará disponible para que otros atletas puedan elegirlo.',
        edit: 'Volver a editar',
        confirm: 'Sí, confirmar equipo',
        cancel: 'Cerrar confirmación',
      },
