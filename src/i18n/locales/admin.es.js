export default {
  ...
  dashboard: {
    ...
    traffic: {
      ...
      today: 'Visitantes de hoy hasta ahora',
      personSingular: 'persona visitó el sitio hoy',
      personPlural: 'personas visitaron el sitio hoy',
      vsYesterday: 'vs. ayer: {{delta}}',
  ...
  eventEditor: {
    ...
    sectionVisibilityLeadEssentials:
      'Destacá el meet. Estado, sitio y acceso se controlan arriba en la consola.',
