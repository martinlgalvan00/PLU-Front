...
export function getPublicCatalogEvents(events = [], options = {}) {
  const includeDevelopmentStubs = options?.includeDevelopmentStubs === true
  // El admin/dev puede listar stubs para probar; produccion debe ocultarlos.
