 ...
 * mano. El interruptor que los habilita difiere: Wise usa el propio
 * (`wiseEnabled`, ver `assertWiseEnabled`), no `*_manual_enabled` ni el
 * override por cupón de los otros dos.
 */
 ...
 * producción — ver `.env.example`). No pasa por `resolve_channel_price`
 * (SQL) ni tiene equivalente `manual_price` en el catálogo ARS: es un
 * importe y una moneda aparte, calculados sólo acá.
 *
