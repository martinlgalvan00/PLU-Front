...
const fixture = pathToFileURL(path.join(__dirname, 'payment-ops-fixture.html')).href
...
for (const vp of viewports) {
  ...
  await page.screenshot({
    path: path.join(__dirname, `payment-ops-${vp.name}-dark.png`),
    fullPage: true,
  })
  ...
  await page.screenshot({
    path: path.join(__dirname, `payment-ops-${vp.name}-light.png`),
    fullPage: true,
  })
