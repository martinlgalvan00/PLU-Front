...
const migration = readFileSync(
  resolve(process.cwd(), 'supabase/migrations/20260818100000_embedded_attempt_terminal_status_guard.sql'),
  'utf8',
)
...
describe('claim_embedded_payment_attempt bloquea estados terminales', () => {
  it('agrega la guarda de cancelado/reembolsado sin tocar el resto del contrato', () => {
    ...
    expect(migration).toContain("raise exception 'La orden ya no admite un nuevo intento de pago.' using errcode = 'PLU09';")
