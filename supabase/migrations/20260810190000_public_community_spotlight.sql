-- Spotlight de comunidad (home): afiliados recientes públicos y stats agregados.
-- Solo expone nombre abreviado + gym + provincia; sin DNI, email ni member_code.
...
comment on function public.public_list_community_spotlight(int) is
  'Feed público del home: afiliados activos recientes (nombre abreviado) + stats agregados.';
