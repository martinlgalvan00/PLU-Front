-- Recent registration identity for the public event summary.
-- The API signs `photoPath` and removes it before responding, so storage paths,
-- documents and email addresses never leave the server.
