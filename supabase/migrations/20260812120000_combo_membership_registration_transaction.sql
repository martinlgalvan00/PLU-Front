-- Combo afiliacion + inscripcion en una sola transaccion.
--
-- La orden es la unica fuente economica: el browser solo informa evento,
-- datos competitivos, medio de pago e idempotencia. Precio, moneda y plan se
-- bloquean y releen desde event_combo_offers / membership_plans.
