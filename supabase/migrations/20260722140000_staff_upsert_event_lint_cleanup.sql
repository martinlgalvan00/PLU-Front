-- Limpia la unica advertencia restante de plpgsql_check: el INSERT de dias
-- no necesita capturar el id porque los ids se consultan despues por event_id
-- y day_index. El contrato y los permisos de la RPC no cambian.
