-- ---------------------------------------------------------------------------
-- create_membership_order_v2: no explotar con memberships_athlete_id_year_key
--
-- El INSERT puro fallaba cuando ya existía una fila del mismo (athlete_id, year)
-- que no se detectaba como `v_pending` (p. ej. pendiente de otro plan, plan_id
-- null, o cancelada/reembolsada/vencida del mismo año). La UI permite volver a
-- pagar en esos estados, así que la RPC tiene que reusar/actualizar la fila.
-- ---------------------------------------------------------------------------
